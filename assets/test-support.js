...
define('ember-flexberry/test-support/check-close-edit-form', [], function () {
  ...
  Ember.Test.registerAsyncHelper('checkCloseEditForm', function (app, olvSelector, context, assert, path) {
    ...
    var editFormRoute = Ember.get(controller, 'editFormRoute');
...
define('ember-flexberry/test-support/check-delete-record-from-e-form', ['moment', 'ember-flexberry-data/utils/generate-unique-id', 'ember-flexberry/test-support/utils/create-recort-for-test'], function (_moment, _generateUniqueId, _createRecortForTest) {
  ...
  Ember.Test.registerAsyncHelper('checkDeleteRecordFromEditForm', function (app, olvSelector, context, assert, store, model, prop) {
    ...
    var deleteRecordId = (0, _generateUniqueId.default)();

    (0, _createRecortForTest.createRecord)(store, model, prop, deleteRecordId, currentData).then(function () {
      assert.expect(assert.expect() + 4);

      var currentPathPage = helpers.currentPath();
      ...
      helpers.andThen(function () {
        ...
        var controller = app.__container__.lookup('controller:' + helpers.currentPath());
        var editFormRoute = Ember.get(controller, 'editFormRoute');
        var waiterFunction = function waiterFunction() {
          return helpers.currentPath() === editFormRoute;
        };
...
define('ember-flexberry/test-support/check-delete-record-from-olv', ['moment', 'ember-flexberry-data/utils/generate-unique-id'], function (_moment, _generateUniqueId) {
  ...
  Ember.Test.registerAsyncHelper('checkDeleteRecordFromOlv', function (app, olvSelector, context, assert, store, model, prop) {
    ...
    var currentData = (0, _moment.default)().format('DD.MM.YYYY HH:mm');
    var deleteUseRowButton = (0, _generateUniqueId.default)();
    var deleteUseRowMeny = (0, _generateUniqueId.default)();
    var deleteUseToolbar1 = (0, _generateUniqueId.default)();
    var deleteUseToolbar2 = (0, _generateUniqueId.default)();

    Ember.RSVP.all([createRecord(store, model, prop, deleteUseRowButton, currentData), createRecord(store, model, prop, deleteUseRowMeny, currentData), createRecord(store, model, prop, deleteUseToolbar1, currentData), createRecord(store, model, prop, deleteUseToolbar2, currentData)]).then(function () {
...
define('ember-flexberry/test-support/check-lock-edit-form', ['moment', 'ember-flexberry-data/utils/generate-unique-id', 'ember-flexberry/test-support/utils/create-recort-for-test'], function (_moment, _generateUniqueId, _createRecortForTest) {
  ...
  Ember.Test.registerAsyncHelper('checkLockEditForm', function (app, olvSelector, context, assert, store, model, prop, path) {
    ...
    var currentData = (0, _moment.default)().format('DD.MM.YYYY HH:mm');
    var testRecord = (0, _generateUniqueId.default)();
    ...
    Ember.RSVP.all([(0, _createRecortForTest.createRecord)(store, model, prop, testRecord, currentData), lockRecord.save()]).then(function () {
...
define('ember-flexberry/test-support/check-olv-sort-for-each-column', ['ember-flexberry/test-support/utils/check-olv-sort-function'], function (_checkOlvSortFunction) {
  ...
  var checkColumns = function checkColumns(headCells, index, olv, helpers, assert) {
    ...
    helpers.andThen(function () {
      var sortValue = (0, _checkOlvSortFunction.getHeaderSort)(olv, index, helpers);
...
define('ember-flexberry/test-support/open-editform', [], function () {
  ...
  Ember.Test.registerAsyncHelper('openEditform', function (app, olvSelector, context, assert, editRoute) {
    ...
    var controller = app.__container__.lookup('controller:' + helpers.currentRouteName());
